...
{
    public partial class Derechoshumanos : Form, Derechoshumanos
    {
        //Fields
        ...
        private static Derechoshumanos instance;
        public static Derechoshumanos GetInstace(Form parentContainer)
        {
            if (instance == null || instance.IsDisposed)
            {
                instance = new Derechoshumanos();
